...
// // Process check outcome and update the check data as needed, trigger an alert if needed
// // Special logic for accomodating a check that has never been tested before (don't alert on that one)
...
//     // Execute all checks
//     workers.gatherAllChecks();
//     // Call a loop so that checks continue to execute later on on their own
//     workers.loop();
// };
